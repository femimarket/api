...
/// POSTs a Flux2KleinI2I Model to femi.market with HTTP Basic auth (`user:password`).
/// `image_b64` is the input subject; `image2_b64` is the reference image.
...
pub extern "C" fn rust_ffi_flux2_klein_i2i(
    ...
    let body = serde_json::json!({
        ...
        "action": {
            ...
            "image2": s(image2_b64).unwrap_or_default(),
