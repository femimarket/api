...
struct Qwen3_6_35b_a3b_2Gen50_100WordMultishotTimestampedPromptFrom2XmpImagePromptsTests {
    ...
    @Test func returnsPrompt() async throws {
        let result = await Api.qwen3_6_35b_a3b_2Gen50_100WordMultishotTimestampedPromptFrom2XmpImagePrompts(xmpPrompt: xmpPrompt, xmpPrompt2: xmpPrompt2)
        print(result)
    ...
    @Test func cancellationReturnsFallback() async throws {
        let task = Task {
            await Api.qwen3_6_35b_a3b_2Gen50_100WordMultishotTimestampedPromptFrom2XmpImagePrompts(xmpPrompt: xmpPrompt, xmpPrompt2: xmpPrompt2)
        }
