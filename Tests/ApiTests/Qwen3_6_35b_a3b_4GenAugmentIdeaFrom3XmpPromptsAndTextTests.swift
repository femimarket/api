...
struct Qwen3_6_35b_a3b_4GenAugmentIdeaFrom3XmpPromptsAndTextTests {
    ...
    let text = "tie the three shots into one continuous journey"

    @Test func returnsPrompt() async throws {
        let result = await Api.qwen3_6_35b_a3b_4GenAugmentIdeaFrom3XmpPromptsAndText(xmpPrompt: xmpPrompt, xmpPrompt2: xmpPrompt2, xmpPrompt3: xmpPrompt3, text: text)
        print(result)
    ...
    @Test func cancellationReturnsFallback() async throws {
        let task = Task {
            await Api.qwen3_6_35b_a3b_4GenAugmentIdeaFrom3XmpPromptsAndText(xmpPrompt: xmpPrompt, xmpPrompt2: xmpPrompt2, xmpPrompt3: xmpPrompt3, text: text)
        }
