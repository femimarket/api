...
struct Qwen3_6_35b_a3b_1GenRandomIdeaFromXmpPromptTests {
    ...
    @Test func returnsPrompt() async throws {
        let result = await Api.qwen3_6_35b_a3b_1GenRandomIdeaFromXmpPrompt(xmpPrompt: xmpPrompt)
        print(result)
    ...
    @Test func cancellationReturnsFallback() async throws {
        let task = Task {
            await Api.qwen3_6_35b_a3b_1GenRandomIdeaFromXmpPrompt(xmpPrompt: xmpPrompt)
        }
