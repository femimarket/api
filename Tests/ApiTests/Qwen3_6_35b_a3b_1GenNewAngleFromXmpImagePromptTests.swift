...
struct Qwen3_6_35b_a3b_1GenNewAngleFromXmpImagePromptTests {
    ...
    @Test func returnsPrompt() async throws {
        let result = await Api.qwen3_6_35b_a3b_1GenNewAngleFromXmpImagePrompt(xmpPrompt: xmpPrompt)
        print(result)
    ...
    @Test func cancellationReturnsFallback() async throws {
        let task = Task {
            await Api.qwen3_6_35b_a3b_1GenNewAngleFromXmpImagePrompt(xmpPrompt: xmpPrompt)
        }
