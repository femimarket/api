...
open class WiseAPI {
    ...
    /**
     ...
     - returns: Wise
     */
    open class func wiseCheck(amountCents: Int64, currency: String, id: UUID, reference: String, status: Status, userId: String, credit: Int64? = nil, loaded: Bool? = nil, wiseCreditId: String? = nil, apiConfiguration: ApiAPIConfiguration = ApiAPIConfiguration.shared) async throws(ErrorResponse) -> Wise {
        return try await wiseCheckWithRequestBuilder(amountCents: amountCents, currency: currency, id: id, reference: reference, status: status, userId: userId, credit: credit, loaded: loaded, wiseCreditId: wiseCreditId, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func wiseCheckWithRequestBuilder(amountCents: Int64, currency: String, id: UUID, reference: String, status: Status, userId: String, credit: Int64? = nil, loaded: Bool? = nil, wiseCreditId: String? = nil, apiConfiguration: ApiAPIConfiguration = ApiAPIConfiguration.shared) -> RequestBuilder<Wise> {
        let localVariablePath = "/wise_check"
