...
open class ApiAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = ApiAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: ApiAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: ApiAPIConfiguration = ApiAPIConfiguration.shared
    ) {
        self.method = method
